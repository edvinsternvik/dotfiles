...
globalkeys = gears.table.join(
    ...
    -- rofi
    awful.key({ modkey, "Shift" }, "Return", function () awful.spawn("rofi -modi \"power:~/.config/rofi/rofi-power-menu --confirm=''\" -combi-modi drun,power -show combi") end,
        {description = "search for application with rofi", group = "hotkeys"}),
    awful.key({ modkey, "Control" }, "Return", function () awful.spawn("rofi -show window") end,
        {description = "search for window with rofi", group = "hotkeys"}),

    -- Hotkeys Awesome
    awful.key({ modkey,           }, "s",      hotkeys_popup.show_help,
        {description = "show help", group="awesome"}),

    -- View tag 1 on all displays
    awful.key({}, "Menu", function ()
        ...
        {description = "view tag 1 on all displays", group = "tag"}),
    ...
    awful.key({ modkey, "Shift"   }, "j",
        function ()
            if client.focus and client.focus.floating then client.focus:relative_move(0, 32, 0, 0)
            else awful.client.swap.global_bydirection("down") end
        end,
        {description = "swap with client below", group = "client"}),
    awful.key({ modkey, "Shift"   }, "k",
        function ()
            if client.focus and client.focus.floating then client.focus:relative_move(0, -32, 0, 0)
            else awful.client.swap.global_bydirection("up") end
        end,
        {description = "swap with client above", group = "client"}),
    awful.key({ modkey, "Shift"   }, "h",
        function ()
            if client.focus and client.focus.floating then client.focus:relative_move(-32, 0, 0, 0)
            else awful.client.swap.global_bydirection("left") end
        end,
        {description = "swap with client to the left", group = "client"}),
    awful.key({ modkey, "Shift"   }, "l",
        function ()
            if client.focus and client.focus.floating then client.focus:relative_move(32, 0, 0, 0)
            else awful.client.swap.global_bydirection("right") end
        end,
    ...
    awful.key({ modkey, "Control" }, "h",
        function ()
            if client.focus and client.focus.floating then client.focus:relative_move(0, 0, -32, 0)
            else awful.tag.incmwfact(-0.05) end
        end,
        {description = "resize horizontal -", group = "client"}),
    awful.key({ modkey, "Control" }, "j",
        function ()
            if client.focus and client.focus.floating then client.focus:relative_move(0, 0, 0, 32)
            else awful.client.incwfact(-0.05) end
        end,
...
client.connect_signal("manage", function (c)
 ...
 --Always keep floating windows on top
